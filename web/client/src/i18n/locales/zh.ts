export default {
  ...
  // Flow Studio（独立于项目的流程）
  flowStudio: {
    title: 'Flow Studio',
    create: '创建工作室',
    open: '打开',
    emptyTitle: '还没有工作室',
    emptyDesc: '一个文件夹即一个工作室 — 创建新工作室开始使用',
    createSuccess: '工作室「{name}」已创建',
    agentModal: {
      trigger: '添加代理',
      title: '创建新代理',
      nameLabel: '名称 (a-z, 0-9, -)',
      namePlaceholder: '例如: researcher',
      modelLabel: '模型',
      roleLabel: '角色',
      rolePlaceholder: '描述该代理将承担的角色',
      rulesLabel: '规则（可选）',
      rulesPlaceholder: '该代理应遵循的规则/指南…',
      rankLabel: '等级',
      effortLabel: '思考深度',
      effortNone: '未指定',
      aliasLatest: '自动最新',
    ...
    createModal: {
      title: '新建 Flow Studio',
      nameLabel: '名称',
      namePlaceholder: '例如: 市场调研工作室',
      pathLabel: '文件夹路径（绝对路径）',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: '开始方式',
      modeBlank: '空白工作室',
      modeBlankDesc: '从空白画布开始 — 自行添加代理和流程',
      modePreset: '团队预设',
      modePresetDesc: '立即应用预置的团队和流程',
      modeAi: 'AI团队设计',
      modeAiDesc: '输入目标，让flowsmith设计团队和流程',
      goalLabel: '目标',
      goalPlaceholder: '描述该工作室要达成的目标…',
      skipDesignHint: '未输入目标 — 跳过AI团队生成',
      designRunning: 'AI正在组建代理团队与流程…',
      designSuccess: 'AI团队生成完成 — 代理和流程已就绪',
      designFailed: 'AI团队生成失败',
      presetRunning: '正在应用预设…',
      presetSuccess: '预设应用完成 — 团队和流程已就绪',
      presetFailed: '预设应用失败',
      skipDesign: '直接打开',
      designRun: '生成AI团队',
      openEditor: '打开编辑器',
    ...
    redesignModal: {
      ...
      title: '重新设计团队与流程',
      feedbackLabel: '反馈',
      feedbackPlaceholder: '描述您想要更改的内容…',
      redesign: '重新设计',
      success: '重新设计完成 — 流程已更新',
      failed: '重新设计失败',
    },
    errors: {
      nameRequired: '请输入工作室名称',
      pathRequired: '请输入文件夹路径（例如 C:/01_xuefeng/my-studio）',
      nameInvalid: '名称只能包含小写字母、数字和 -',
      modelInvalid: '模型 ID 只能包含字母、数字和 . _ -',
      createFailed: '创建工作室失败',
      duplicate: '已存在同名/同路径的工作室',
      invalidPath: '路径无效',
      initFailed: '工作室初始化失败',
      presetRequired: '请选择一个预设',
      goalRequired: '请输入AI团队设计的目标',
      feedbackRequired: '请输入描述所需更改的反馈',
      tooLong: '输入过长（最多512字符）',
      newline: '不允许换行',
  ...
  flowEditor: {
    ...
    viewRaw: '完整日志',
    runPreamble: '启动中',
    sectionNoOutput: '暂无输出',
    currentStepLabel: '当前步骤: {step} ({soul})',
    currentStepLabelNoSoul: '当前步骤: {step}',
    btnExpand: '展开面板',
    btnRestore: '还原面板',
    resizeHint: '拖动以调整大小',
    nodeRunningBadge: '运行中',
  },
}
