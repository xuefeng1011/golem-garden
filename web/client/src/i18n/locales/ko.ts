export default {
  ...
  // 플로우 편집기
  flowEditor: {
    noProject: '프로젝트를 선택하지 않았습니다',
    noProjectDesc: '플로우 편집기를 사용하려면 프로젝트를 선택하세요',
    emptyTitle: '아직 단계가 없습니다',
    emptyDesc: '단계를 추가하거나 템플릿으로 시작하세요',
    templateSerial: '직렬 템플릿 (설계 → 구현 → 검증)',
    templateParallel: '병렬 템플릿 (구현 × 2 → 검증)',
    templateSerialGoal: '기능 설계, 구현, 검증',
    templateParallelGoal: '병렬 구현 후 검증',
    templateDesign: '솔루션 설계',
    templateImpl: '기능 구현',
    templateImpl2: '대안 구현',
    templateVerify: '결과 검증',
    goalPlaceholder: '워크플로우 목표…',
    defaultGoal: '제목 없는 워크플로우',
    btnAddStep: '단계 추가',
    btnAddStepTip: '새 단계 노드 추가',
    btnAutoLayout: '자동 정렬',
    btnAutoLayoutTip: 'Dagre LR 레이아웃으로 노드 재배치',
    btnValidate: '검증',
    btnValidateTip: '작업 내용 누락 여부 확인',
    btnSave: '저장',
    btnRun: '실행',
    stepDetail: '단계 상세',
    labelSoul: '담당 SOUL',
    soulHost: '호스트(직접)',
    labelTask: '작업 내용',
    taskPlaceholder: '이 단계에서 수행할 작업을 설명하세요…',
    taskRequired: '작업 내용을 입력해 주세요',
    labelRetry: '재시도 횟수 (0~3)',
    labelApproval: '승인 게이트',
    labelOnFail: '실패 시',
    onFailAbort: '중단',
    onFailContinue: '계속',
    onFailGoto: '특정 단계로…',
    labelGotoStep: '대상 단계',
    gotoPlaceholder: '단계 선택…',
    validateErrors: '{n}개 단계에 작업 내용이 없습니다',
    validateOk: '모든 단계가 정상입니다',
    saveSuccess: '워크플로우 저장됨',
    saveFailed: '저장 실패',
    runPanelTitle: '실행 출력',
    running: '실행 중…',
    runLogEmpty: '아직 출력이 없습니다 — 실행 버튼을 클릭하세요',
    ...
    viewRaw: '전체 로그',
    runPreamble: '실행 준비',
    sectionNoOutput: '출력 없음',
    currentStepLabel: '현재 단계: {step} ({soul})',
    currentStepLabelNoSoul: '현재 단계: {step}',
    btnExpand: '패널 확장',
    btnRestore: '패널 축소',
    resizeHint: '드래그하여 크기 조절',
    nodeRunningBadge: '실행 중',
  },

  // Flow Studio (프로젝트 독립 플로우)
  flowStudio: {
    title: 'Flow Studio',
    create: '스튜디오 생성',
    open: '열기',
    emptyTitle: '아직 스튜디오가 없습니다',
    emptyDesc: '폴더 하나가 스튜디오 하나입니다 — 새 스튜디오를 만들어 시작하세요',
    createSuccess: '스튜디오 "{name}" 생성됨',
    agentModal: {
      trigger: '에이전트 생성',
      title: '새 에이전트 생성',
      nameLabel: '이름 (a-z, 0-9, -)',
      namePlaceholder: '예: researcher',
      modelLabel: '모델',
      roleLabel: '역할',
      rolePlaceholder: '이 에이전트가 맡을 역할을 설명하세요',
      rulesLabel: '규칙 (선택)',
      rulesPlaceholder: '이 에이전트가 지킬 규칙/지침…',
      rankLabel: '랭크',
      effortLabel: '사고 깊이',
      effortNone: '지정 안 함',
      aliasLatest: '항상 최신',
      create: '생성',
      success: '에이전트가 생성되었습니다',
    },
    createModal: {
      title: '새 Flow Studio',
      nameLabel: '이름',
      namePlaceholder: '예: 시장조사 스튜디오',
      pathLabel: '폴더 경로 (절대 경로)',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: '시작 방식',
      modeBlank: '빈 스튜디오',
      modeBlankDesc: '빈 캔버스로 시작 — 에이전트와 플로우를 직접 구성하세요',
      modePreset: '팀 프리셋',
      modePresetDesc: '미리 구성된 팀과 플로우를 즉시 적용합니다',
      modeAi: 'AI 팀 설계',
      modeAiDesc: '목표를 입력하면 flowsmith가 팀과 플로우를 설계합니다',
      goalLabel: '목표',
      goalPlaceholder: '이 스튜디오가 이룰 목표를 설명하세요…',
      skipDesignHint: '목표를 입력하지 않아 AI 팀 생성을 건너뜁니다',
      designRunning: 'AI가 에이전트 팀과 플로우를 구성하는 중…',
      designSuccess: 'AI 팀 생성 완료 — 에이전트와 플로우가 구성되었습니다',
      designFailed: 'AI 팀 생성 실패',
      presetRunning: '프리셋 적용 중…',
      presetSuccess: '프리셋 적용 완료 — 팀과 플로우가 준비되었습니다',
      presetFailed: '프리셋 적용 실패',
      skipDesign: '그냥 열기',
      designRun: 'AI 팀 생성',
      openEditor: '편집기 열기',
    },
    redesignModal: {
      ...
      title: '팀 & 플로우 재설계',
      feedbackLabel: '피드백',
      feedbackPlaceholder: '바꾸고 싶은 내용을 설명하세요…',
      redesign: '재설계',
      success: '재설계 완료 — 플로우가 갱신되었습니다',
      failed: '재설계 실패',
    },
    errors: {
      nameRequired: '스튜디오 이름을 입력하세요',
      pathRequired: '폴더 경로를 입력하세요 (예: C:/01_xuefeng/my-studio)',
      nameInvalid: '이름은 소문자, 숫자, - 만 사용할 수 있어요',
      modelInvalid: '모델 ID 는 영문, 숫자, . _ - 만 사용할 수 있어요',
      createFailed: '스튜디오 생성 실패',
      duplicate: '이미 같은 이름/경로의 스튜디오가 있습니다',
      invalidPath: '유효하지 않은 경로입니다',
      initFailed: '스튜디오 초기화에 실패했습니다',
      presetRequired: '프리셋을 선택하세요',
      goalRequired: 'AI 팀 설계를 위한 목표를 입력하세요',
      feedbackRequired: '변경하고 싶은 내용을 피드백으로 입력하세요',
      tooLong: '입력이 너무 길어요 (최대 512자)',
