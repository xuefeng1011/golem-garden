export default {
  ...
  // Flow Studio（プロジェクト独立フロー）
  flowStudio: {
    title: 'Flow Studio',
    create: 'スタジオを作成',
    open: '開く',
    emptyTitle: 'まだスタジオがありません',
    emptyDesc: 'フォルダ1つ＝スタジオ1つ — 新しいスタジオを作成して始めましょう',
    createSuccess: 'スタジオ「{name}」を作成しました',
    agentModal: {
      trigger: 'エージェントを追加',
      title: '新しいエージェントを作成',
      nameLabel: '名前 (a-z, 0-9, -)',
      namePlaceholder: '例: researcher',
      modelLabel: 'モデル',
      roleLabel: '役割',
      rolePlaceholder: 'このエージェントが担う役割を記入してください',
      rulesLabel: 'ルール（任意）',
      rulesPlaceholder: 'このエージェントが従うルール・指針…',
      rankLabel: 'ランク',
      effortLabel: '思考の深さ',
      effortNone: '指定なし',
      aliasLatest: '常に最新',
      create: '作成',
      success: 'エージェントを作成しました',
    },
    createModal: {
      title: '新しい Flow Studio',
      nameLabel: '名前',
      namePlaceholder: '例: 市場調査スタジオ',
      pathLabel: 'フォルダパス（絶対パス）',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: '開始方法',
      modeBlank: '空のスタジオ',
      modeBlankDesc: '空のキャンバスから開始 — エージェントとフローを自分で追加',
      modePreset: 'チームプリセット',
      modePresetDesc: '既製のチームとフローを即座に適用します',
      modeAi: 'AIチーム設計',
      modeAiDesc: '目標を入力すると flowsmith がチームとフローを設計します',
      goalLabel: '目標',
      goalPlaceholder: 'このスタジオで達成したいことを記入してください…',
      skipDesignHint: '目標が入力されていないため、AIチーム生成をスキップします',
      designRunning: 'AIがエージェントチームとフローを構成しています…',
      designSuccess: 'AIチームの生成が完了しました — エージェントとフローが準備できました',
      designFailed: 'AIチームの生成に失敗しました',
      presetRunning: 'プリセットを適用しています…',
      presetSuccess: 'プリセットを適用しました — チームとフローの準備が完了しました',
      presetFailed: 'プリセットの適用に失敗しました',
      skipDesign: 'そのまま開く',
      designRun: 'AIチームを生成',
      openEditor: 'エディタを開く',
    },
    redesignModal: {
      ...
      feedbackPlaceholder: '変更したい内容を記入してください…',
      redesign: '再設計',
      success: '再設計が完了しました — フローが更新されました',
      failed: '再設計に失敗しました',
    },
    errors: {
      nameRequired: 'スタジオ名を入力してください',
      pathRequired: 'フォルダパスを入力してください（例: C:/01_xuefeng/my-studio）',
      nameInvalid: '名前には小文字・数字・- のみ使用できます',
      modelInvalid: 'モデル ID には英数字と . _ - のみ使用できます',
      createFailed: 'スタジオの作成に失敗しました',
      duplicate: '同じ名前/パスのスタジオが既に存在します',
      invalidPath: '無効なパスです',
      initFailed: 'スタジオの初期化に失敗しました',
      presetRequired: 'プリセットを選択してください',
      goalRequired: 'AIチーム設計の目標を入力してください',
      feedbackRequired: '変更したい内容をフィードバックとして入力してください',
      tooLong: '入力が長すぎます（最大512文字）',
      newline: '改行は使用できません',
    ...
    delete: {
      button: '削除',
      title: 'スタジオを削除',
      confirm: '「{name}」を一覧から削除しますか？フォルダと成果物はディスクに残ります。',
      success: 'スタジオ「{name}」を削除しました',
      error: 'スタジオの削除に失敗しました',
    },
  },
  ...
  flowEditor: {
    ...
    noProjectDesc: 'フローエディタを使用するにはプロジェクトを選択してください',
    emptyTitle: 'まだステップがありません',
    emptyDesc: 'ステップを追加するか、テンプレートから始めてワークフローを作成しましょう',
    templateSerial: '直列テンプレート(設計→実装→検証)',
    templateParallel: '並列テンプレート(実装×2→検証)',
    templateSerialGoal: '機能を設計・実装・検証する',
    templateParallelGoal: '並列実装の後に検証する',
    templateDesign: '解決策を設計する',
    templateImpl: '機能を実装する',
    templateImpl2: '代替案を実装する',
    templateVerify: '結果を検証する',
    goalPlaceholder: 'ワークフローの目標…',
    defaultGoal: '無題のワークフロー',
    btnAddStep: 'ステップを追加',
    btnAddStepTip: '新しいステップノードを追加',
    btnAutoLayout: '自動レイアウト',
    btnAutoLayoutTip: 'Dagre LRレイアウトでノードを再配置',
    btnValidate: '検証',
    btnValidateTip: '不足しているタスク内容を確認',
    btnSave: '保存',
    btnRun: '実行',
    stepDetail: 'ステップ詳細',
    labelSoul: '担当SOUL',
    soulHost: 'ホスト(直接)',
    labelTask: 'タスク内容',
    taskPlaceholder: 'このステップで行うことを記述してください…',
    taskRequired: 'タスク内容は必須です',
    labelRetry: '再試行回数(0〜3)',
    labelApproval: '承認ゲート',
    labelOnFail: '失敗時',
    onFailAbort: '中止',
    onFailContinue: '続行',
    onFailGoto: '指定ステップへ移動…',
    labelGotoStep: '対象ステップ',
    gotoPlaceholder: 'ステップを選択…',
    validateErrors: '{n}件のステップにタスク内容がありません',
    validateOk: 'すべてのステップは問題ありません',
    saveSuccess: 'ワークフローを保存しました',
    saveFailed: '保存に失敗しました',
    runPanelTitle: '実行出力',
    running: '実行中…',
    runLogEmpty: 'まだ出力はありません — 実行をクリックして開始してください',
    approvalPending: '承認待ち:',
    btnApprove: '承認',
    btnReject: '拒否',
    approved: 'ステップを承認しました',
    rejected: 'ステップを拒否しました',
    runDone: 'ワークフローが完了しました',
    runFailed: 'ワークフローが失敗しました',
    runWaiting: '一時停止中 — 承認が必要です',
    phaseDone: '完了',
    phaseFailed: '失敗',
    phaseWaiting: '承認待ち',
    leaveTitle: '未保存の変更',
    leaveContent: '未保存の変更があります。保存せずに離れますか?',
    leaveConfirm: '離れる',
    savedFlows: '保存済みワークフロー',
    savedFlowsPlaceholder: '保存済みワークフローを選択…',
    newFlow: '新規',
    deleteFlow: '削除',
    deleteFlowConfirm: 'このワークフローを削除しますか?元に戻せません。',
    deleteTitle: 'ワークフローを削除',
    deleted: 'ワークフローを削除しました',
    btnStop: '停止',
    deleteFlowSuccess: 'ワークフローを削除しました',
    deleteFlowFailed: 'ワークフローの削除に失敗しました',
    switchDirtyTitle: '未保存の変更',
    switchDirtyContent: '未保存の変更があります。保存せずに切り替えますか?',
    switchDirtyConfirm: '切り替える',
    progressCount: '{done}/{total} 完了',
    emptyDescWithFlows: '保存済みのワークフローを読み込むか、テンプレートから始めてください',
    btnDeleteStep: 'このステップを削除',
    btnViewResult: '結果を表示',
    btnAddInput: '入力を追加',
    btnAddInputTip: '入力ノードを追加(パイプラインの入力値)',
    btnAddAgent: 'エージェントを追加',
    btnAddAgentTip: 'エージェントのステップノードを追加',
    nodeKindInput: '入力',
    inputValueLabel: '入力値',
    inputValuePlaceholder: 'パイプラインに渡す値…',
    insertRefHint: "{'{{step-id}}'} でその前のステップの出力を挿入できます",
    refChipsLabel: '前のステップ',
    runInputTitle: '入力を入力',
    runInputDesc: 'このワークフローは入力ノードから始まります。実行に使う値を入力してください。',
    runInputConfirm: '入力して実行',
    resolvedInputLabel: '受け取った入力(解決済み)',
    outputLabel: '出力',
    directorWarning: 'このソウルはDirector(委任専用)のため、コンテンツを直接生成できません — コンテンツ/コードのステップには書き込みツールを持つソウルを使用してください。',
    unresolvedRefWarning: '不明なステップへの参照: {refs} — 誤字か削除されたステップの可能性があります。チップをクリックして有効な参照を挿入してください。',
    failureReasonLabel: '失敗の理由',
    viewGrouped: 'グループ表示',
    viewRaw: '全ログ',
    runPreamble: '起動中',
    sectionNoOutput: 'まだ出力はありません',
    currentStepLabel: '現在のステップ: {step} ({soul})',
    currentStepLabelNoSoul: '現在のステップ: {step}',
    btnExpand: 'パネルを拡大',
    btnRestore: 'パネルを元に戻す',
    resizeHint: 'ドラッグしてサイズ変更',
    nodeRunningBadge: '実行中',
  },
}
