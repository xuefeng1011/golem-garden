export default {
  ...
  // Flow Studio (fluxos independentes do projeto)
  flowStudio: {
    title: 'Flow Studio',
    create: 'Criar estudio',
    open: 'Abrir',
    emptyTitle: 'Ainda nao ha estudios',
    emptyDesc: 'Uma pasta e um estudio — crie um novo estudio para comecar',
    createSuccess: 'Estudio "{name}" criado',
    agentModal: {
      trigger: 'Adicionar agente',
      title: 'Criar novo agente',
      nameLabel: 'Nome (a-z, 0-9, -)',
      namePlaceholder: 'ex.: researcher',
      modelLabel: 'Modelo',
      roleLabel: 'Funcao',
      rolePlaceholder: 'Descreva a funcao que este agente vai desempenhar',
      rulesLabel: 'Regras (opcional)',
      rulesPlaceholder: 'Regras/diretrizes que este agente deve seguir...',
      rankLabel: 'Classificacao',
      effortLabel: 'Nivel de esforco',
      effortNone: 'Nao especificado',
      aliasLatest: 'sempre a mais recente',
      create: 'Criar',
      success: 'Agente criado',
    },
    createModal: {
      title: 'Novo Flow Studio',
      nameLabel: 'Nome',
      namePlaceholder: 'ex.: Estudio de pesquisa de mercado',
      pathLabel: 'Caminho da pasta (absoluto)',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: 'Como deseja comecar?',
      modeBlank: 'Estudio vazio',
      modeBlankDesc: 'Comece com uma tela vazia — adicione agentes e fluxos voce mesmo',
      modePreset: 'Modelo de equipe',
      modePresetDesc: 'Aplique instantaneamente uma equipe e fluxo pre-configurados',
      modeAi: 'Design com IA',
      modeAiDesc: 'Descreva um objetivo e deixe o flowsmith projetar a equipe e o fluxo',
      goalLabel: 'Objetivo',
      goalPlaceholder: 'Descreva o que este estudio deve alcancar...',
      skipDesignHint: 'Nenhum objetivo informado — pulando a geracao da equipe de IA',
      designRunning: 'A IA esta montando a equipe de agentes e o fluxo...',
      designSuccess: 'Equipe de IA gerada — agentes e fluxo prontos',
      designFailed: 'Falha ao gerar a equipe de IA',
      presetRunning: 'Aplicando o modelo...',
      presetSuccess: 'Modelo aplicado — equipe e fluxo estao prontos',
      presetFailed: 'Falha ao aplicar o modelo',
      skipDesign: 'Apenas abrir',
      designRun: 'Gerar equipe de IA',
      openEditor: 'Abrir editor',
    },
    redesignModal: {
      trigger: 'Reprojetar',
      title: 'Reprojetar equipe e fluxo',
      feedbackLabel: 'Feedback',
      feedbackPlaceholder: 'Descreva o que voce gostaria de mudar...',
      redesign: 'Reprojetar',
      success: 'Reprojeto concluido — fluxo atualizado',
      failed: 'Falha ao reprojetar',
    },
    errors: {
      nameRequired: 'Informe um nome para o estudio',
      pathRequired: 'Informe um caminho de pasta (ex.: C:/01_xuefeng/my-studio)',
      nameInvalid: 'O nome so pode conter minusculas, numeros e -',
      modelInvalid: 'O ID do modelo so pode conter letras, numeros e . _ -',
      createFailed: 'Falha ao criar o estudio',
      duplicate: 'Ja existe um estudio com esse nome/caminho',
      invalidPath: 'Caminho invalido',
      initFailed: 'Falha na inicializacao do estudio',
      presetRequired: 'Selecione um modelo',
      goalRequired: 'Informe um objetivo para o design com IA',
      feedbackRequired: 'Informe um feedback descrevendo a mudanca desejada',
      tooLong: 'Entrada muito longa (max. 512 caracteres)',
    ...
    delete: {
      ...
      confirm: 'Excluir "{name}" da lista? A pasta e os artefatos permanecem no disco.',
      success: 'Estudio "{name}" excluido',
      error: 'Falha ao excluir o estudio',
    },
  },
  ...
  flowEditor: {
    ...
    noProjectDesc: 'Selecione um projeto para usar o editor de fluxos',
    emptyTitle: 'Ainda sem etapas',
    emptyDesc: 'Adicione uma etapa ou comece a partir de um modelo para construir seu fluxo de trabalho',
    templateSerial: 'Modelo em serie (Design → Implementacao → Verificacao)',
    templateParallel: 'Modelo paralelo (Implementacao × 2 → Verificacao)',
    templateSerialGoal: 'Projetar, implementar e verificar um recurso',
    templateParallelGoal: 'Implementacao paralela e depois verificacao',
    templateDesign: 'Projetar a solucao',
    templateImpl: 'Implementar o recurso',
    templateImpl2: 'Implementar a alternativa',
    templateVerify: 'Verificar o resultado',
    goalPlaceholder: 'Objetivo do fluxo de trabalho…',
    defaultGoal: 'Fluxo de trabalho sem titulo',
    btnAddStep: 'Adicionar etapa',
    btnAddStepTip: 'Adicionar um novo no de etapa',
    btnAutoLayout: 'Layout automatico',
    btnAutoLayoutTip: 'Reorganizar os nos com o layout Dagre LR',
    btnValidate: 'Validar',
    btnValidateTip: 'Verificar conteudo de tarefa ausente',
    btnSave: 'Salvar',
    btnRun: 'Executar',
    stepDetail: 'Detalhe da etapa',
    labelSoul: 'SOUL atribuido',
    soulHost: 'Host (direto)',
    labelTask: 'Conteudo da tarefa',
    taskPlaceholder: 'Descreva o que esta etapa deve fazer…',
    taskRequired: 'O conteudo da tarefa e obrigatorio',
    labelRetry: 'Novas tentativas (0–3)',
    labelApproval: 'Portao de aprovacao',
    labelOnFail: 'Em caso de falha',
    onFailAbort: 'Abortar',
    onFailContinue: 'Continuar',
    onFailGoto: 'Ir para a etapa…',
    labelGotoStep: 'Etapa de destino',
    gotoPlaceholder: 'Selecione uma etapa…',
    validateErrors: '{n} etapa(s) sem conteudo de tarefa',
    validateOk: 'Todas as etapas estao corretas',
    saveSuccess: 'Fluxo de trabalho salvo',
    saveFailed: 'Falha ao salvar',
    runPanelTitle: 'Saida de execucao',
    running: 'Executando…',
    runLogEmpty: 'Ainda sem saida — clique em Executar para iniciar',
    approvalPending: 'Aprovacao pendente:',
    btnApprove: 'Aprovar',
    btnReject: 'Rejeitar',
    approved: 'Etapa aprovada',
    rejected: 'Etapa rejeitada',
    runDone: 'Fluxo de trabalho concluido',
    runFailed: 'Fluxo de trabalho falhou',
    runWaiting: 'Pausado — aprovacao necessaria',
    phaseDone: 'Concluido',
    phaseFailed: 'Falhou',
    phaseWaiting: 'Aguardando aprovacao',
    leaveTitle: 'Alteracoes nao salvas',
    leaveContent: 'Voce tem alteracoes nao salvas. Sair sem salvar?',
    leaveConfirm: 'Sair',
    savedFlows: 'Fluxos de trabalho salvos',
    savedFlowsPlaceholder: 'Selecione um fluxo de trabalho salvo…',
    newFlow: 'Novo',
    deleteFlow: 'Excluir',
    deleteFlowConfirm: 'Excluir este fluxo de trabalho? Esta acao nao pode ser desfeita.',
    deleteTitle: 'Excluir fluxo de trabalho',
    deleted: 'Fluxo de trabalho excluido',
    btnStop: 'Parar',
    deleteFlowSuccess: 'Fluxo de trabalho excluido',
    deleteFlowFailed: 'Falha ao excluir o fluxo de trabalho',
    switchDirtyTitle: 'Alteracoes nao salvas',
    switchDirtyContent: 'Voce tem alteracoes nao salvas. Trocar sem salvar?',
    switchDirtyConfirm: 'Trocar',
    progressCount: '{done}/{total} concluidos',
    emptyDescWithFlows: 'Carregue um fluxo de trabalho salvo ou comece a partir de um modelo',
    btnDeleteStep: 'Excluir esta etapa',
    btnViewResult: 'Ver resultado',
    btnAddInput: 'Adicionar entrada',
    btnAddInputTip: 'Adicionar um no de entrada (valor de entrada do pipeline)',
    btnAddAgent: 'Adicionar agente',
    btnAddAgentTip: 'Adicionar um no de etapa de agente',
    nodeKindInput: 'Entrada',
    inputValueLabel: 'Valor de entrada',
    inputValuePlaceholder: 'Valor passado para o pipeline…',
    insertRefHint: "{'{{step-id}}'} insere a saida dessa etapa anterior",
    refChipsLabel: 'Etapas anteriores',
    runInputTitle: 'Inserir entrada',
    runInputDesc: 'Este fluxo de trabalho comeca com nos de entrada. Insira os valores para executa-lo.',
    runInputConfirm: 'Inserir e executar',
    resolvedInputLabel: 'Entrada recebida (resolvida)',
    outputLabel: 'Saida',
    directorWarning: 'Este soul e um Director (somente delegacao) e nao pode produzir conteudo diretamente — use um soul com ferramentas de escrita para etapas de conteudo/codigo.',
    unresolvedRefWarning: 'Referencias a etapas desconhecidas: {refs} — provavelmente um erro de digitacao ou uma etapa excluida. Clique em um chip para inserir uma referencia valida.',
    failureReasonLabel: 'Motivo da falha',
    viewGrouped: 'Visao agrupada',
    viewRaw: 'Log completo',
    runPreamble: 'Inicializacao',
    sectionNoOutput: 'Ainda sem saida',
    currentStepLabel: 'Etapa atual: {step} ({soul})',
    currentStepLabelNoSoul: 'Etapa atual: {step}',
    btnExpand: 'Expandir painel',
    btnRestore: 'Restaurar painel',
    resizeHint: 'Arraste para redimensionar',
    nodeRunningBadge: 'Em execucao',
  },
}
