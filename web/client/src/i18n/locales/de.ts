export default {
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit GolemGarden',
  ...
  // Flow Studio (projektunabhangige Flows)
  flowStudio: {
    title: 'Flow Studio',
    create: 'Studio erstellen',
    open: 'Offnen',
    emptyTitle: 'Noch keine Studios',
    emptyDesc: 'Ein Ordner ist ein Studio — erstellen Sie ein neues Studio, um zu beginnen',
    createSuccess: 'Studio "{name}" erstellt',
    agentModal: {
      trigger: 'Agent hinzufugen',
      title: 'Neuen Agenten erstellen',
      nameLabel: 'Name (a-z, 0-9, -)',
      namePlaceholder: 'z. B. researcher',
      modelLabel: 'Modell',
      roleLabel: 'Rolle',
      rolePlaceholder: 'Beschreiben Sie die Rolle dieses Agenten',
      rulesLabel: 'Regeln (optional)',
      rulesPlaceholder: 'Regeln/Richtlinien fur diesen Agenten...',
      rankLabel: 'Rang',
      effortLabel: 'Denktiefe',
      effortNone: 'Nicht angegeben',
      aliasLatest: 'immer aktuell',
      create: 'Erstellen',
      success: 'Agent erstellt',
    },
    createModal: {
      title: 'Neues Flow Studio',
      nameLabel: 'Name',
      namePlaceholder: 'z. B. Marktforschungs-Studio',
      pathLabel: 'Ordnerpfad (absolut)',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: 'Wie mochten Sie beginnen?',
      modeBlank: 'Leeres Studio',
      modeBlankDesc: 'Mit einer leeren Leinwand starten — Agenten und Flows selbst hinzufugen',
      modePreset: 'Team-Vorlage',
      modePresetDesc: 'Ein vorgefertigtes Team und Flow sofort anwenden',
      modeAi: 'KI-Teamdesign',
      modeAiDesc: 'Ziel beschreiben und flowsmith Team und Flow entwerfen lassen',
      goalLabel: 'Ziel',
      goalPlaceholder: 'Beschreiben Sie, was dieses Studio erreichen soll...',
      skipDesignHint: 'Kein Ziel angegeben — KI-Team-Erstellung wird ubersprungen',
      designRunning: 'KI stellt das Agenten-Team und den Flow zusammen...',
      designSuccess: 'KI-Team erstellt — Agenten und Flow sind bereit',
      designFailed: 'KI-Team-Erstellung fehlgeschlagen',
      presetRunning: 'Vorlage wird angewendet...',
      presetSuccess: 'Vorlage angewendet — Team und Flow sind bereit',
      presetFailed: 'Anwenden der Vorlage fehlgeschlagen',
      skipDesign: 'Einfach offnen',
      designRun: 'KI-Team erstellen',
      openEditor: 'Editor offnen',
    },
    redesignModal: {
      trigger: 'Neu entwerfen',
      title: 'Team & Flow neu entwerfen',
      feedbackLabel: 'Feedback',
      feedbackPlaceholder: 'Beschreiben Sie, was Sie andern mochten...',
      redesign: 'Neu entwerfen',
      success: 'Neugestaltung abgeschlossen — Flow aktualisiert',
      failed: 'Neugestaltung fehlgeschlagen',
    },
    errors: {
      nameRequired: 'Bitte Studio-Namen eingeben',
      pathRequired: 'Bitte Ordnerpfad eingeben (z. B. C:/01_xuefeng/my-studio)',
      nameInvalid: 'Name darf nur Kleinbuchstaben, Zahlen und - enthalten',
      modelInvalid: 'Modell-ID darf nur Buchstaben, Zahlen und . _ - enthalten',
      createFailed: 'Erstellen des Studios fehlgeschlagen',
      duplicate: 'Ein Studio mit diesem Namen/Pfad existiert bereits',
      invalidPath: 'Ungultiger Pfad',
      initFailed: 'Studio-Initialisierung fehlgeschlagen',
      presetRequired: 'Bitte eine Vorlage auswahlen',
      goalRequired: 'Bitte ein Ziel fur das KI-Teamdesign eingeben',
      feedbackRequired: 'Bitte ein Feedback zur gewuenschten Aenderung eingeben',
      tooLong: 'Eingabe ist zu lang (max. 512 Zeichen)',
    ...
    delete: {
      button: 'Loeschen',
      title: 'Studio loeschen',
      confirm: '"{name}" aus der Liste entfernen? Der Ordner und die Artefakte bleiben auf der Festplatte.',
      success: 'Studio "{name}" geloescht',
      error: 'Loeschen des Studios fehlgeschlagen',
    },
  },
  ...
  flowEditor: {
    ...
    noProjectDesc: 'Waehlen Sie ein Projekt aus, um den Flow-Editor zu verwenden',
    emptyTitle: 'Noch keine Schritte',
    emptyDesc: 'Fuegen Sie einen Schritt hinzu oder starten Sie mit einer Vorlage, um Ihren Workflow zu erstellen',
    templateSerial: 'Serielle Vorlage (Entwurf → Umsetzung → Pruefung)',
    templateParallel: 'Parallele Vorlage (Umsetzung × 2 → Pruefung)',
    templateSerialGoal: 'Ein Feature entwerfen, umsetzen und pruefen',
    templateParallelGoal: 'Parallele Umsetzung, danach pruefen',
    templateDesign: 'Die Loesung entwerfen',
    templateImpl: 'Das Feature umsetzen',
    templateImpl2: 'Die Alternative umsetzen',
    templateVerify: 'Das Ergebnis pruefen',
    goalPlaceholder: 'Workflow-Ziel…',
    defaultGoal: 'Unbenannter Workflow',
    btnAddStep: 'Schritt hinzufuegen',
    btnAddStepTip: 'Einen neuen Schrittknoten hinzufuegen',
    btnAutoLayout: 'Auto-Layout',
    btnAutoLayoutTip: 'Knoten mit Dagre-LR-Layout neu anordnen',
    btnValidate: 'Pruefen',
    btnValidateTip: 'Auf fehlenden Aufgabeninhalt pruefen',
    btnSave: 'Speichern',
    btnRun: 'Ausfuehren',
    stepDetail: 'Schrittdetails',
    labelSoul: 'Zugewiesener SOUL',
    soulHost: 'Host (direkt)',
    labelTask: 'Aufgabeninhalt',
    taskPlaceholder: 'Beschreiben Sie, was dieser Schritt tun soll…',
    taskRequired: 'Aufgabeninhalt ist erforderlich',
    labelRetry: 'Wiederholungen (0–3)',
    labelApproval: 'Genehmigungsgatter',
    labelOnFail: 'Bei Fehler',
    onFailAbort: 'Abbrechen',
    onFailContinue: 'Fortsetzen',
    onFailGoto: 'Zu Schritt gehen…',
    labelGotoStep: 'Zielschritt',
    gotoPlaceholder: 'Schritt auswaehlen…',
    validateErrors: '{n} Schritt(e) ohne Aufgabeninhalt',
    validateOk: 'Alle Schritte sehen gut aus',
    saveSuccess: 'Workflow gespeichert',
    saveFailed: 'Speichern fehlgeschlagen',
    runPanelTitle: 'Ausfuehrungsausgabe',
    running: 'Laeuft…',
    runLogEmpty: 'Noch keine Ausgabe — klicken Sie auf Ausfuehren, um zu starten',
    approvalPending: 'Genehmigung ausstehend:',
    btnApprove: 'Genehmigen',
    btnReject: 'Ablehnen',
    approved: 'Schritt genehmigt',
    rejected: 'Schritt abgelehnt',
    runDone: 'Workflow abgeschlossen',
    runFailed: 'Workflow fehlgeschlagen',
    runWaiting: 'Pausiert — Genehmigung erforderlich',
    phaseDone: 'Abgeschlossen',
    phaseFailed: 'Fehlgeschlagen',
    phaseWaiting: 'Genehmigung ausstehend',
    leaveTitle: 'Ungespeicherte Aenderungen',
    leaveContent: 'Sie haben ungespeicherte Aenderungen. Ohne Speichern verlassen?',
    leaveConfirm: 'Verlassen',
    savedFlows: 'Gespeicherte Workflows',
    savedFlowsPlaceholder: 'Einen gespeicherten Workflow auswaehlen…',
    newFlow: 'Neu',
    deleteFlow: 'Loeschen',
    deleteFlowConfirm: 'Diesen Workflow loeschen? Dies kann nicht rueckgaengig gemacht werden.',
    deleteTitle: 'Workflow loeschen',
    deleted: 'Workflow geloescht',
    btnStop: 'Stopp',
    deleteFlowSuccess: 'Workflow geloescht',
    deleteFlowFailed: 'Loeschen des Workflows fehlgeschlagen',
    switchDirtyTitle: 'Ungespeicherte Aenderungen',
    switchDirtyContent: 'Sie haben ungespeicherte Aenderungen. Ohne Speichern wechseln?',
    switchDirtyConfirm: 'Wechseln',
    progressCount: '{done}/{total} erledigt',
    emptyDescWithFlows: 'Laden Sie einen gespeicherten Workflow oder starten Sie mit einer Vorlage',
    btnDeleteStep: 'Diesen Schritt loeschen',
    btnViewResult: 'Ergebnis anzeigen',
    btnAddInput: 'Eingabe hinzufuegen',
    btnAddInputTip: 'Einen Eingabeknoten hinzufuegen (Pipeline-Eingabewert)',
    btnAddAgent: 'Agent hinzufuegen',
    btnAddAgentTip: 'Einen Agenten-Schrittknoten hinzufuegen',
    nodeKindInput: 'Eingabe',
    inputValueLabel: 'Eingabewert',
    inputValuePlaceholder: 'Wert, der an die Pipeline uebergeben wird…',
    insertRefHint: "{'{{step-id}}'} fuegt die Ausgabe dieses vorherigen Schritts ein",
    refChipsLabel: 'Vorherige Schritte',
    runInputTitle: 'Eingabe eingeben',
    runInputDesc: 'Dieser Workflow beginnt mit Eingabeknoten. Geben Sie die Werte fuer die Ausfuehrung ein.',
    runInputConfirm: 'Eingeben & ausfuehren',
    resolvedInputLabel: 'Empfangene Eingabe (aufgeloest)',
    outputLabel: 'Ausgabe',
    directorWarning: 'Dieser Soul ist ein Director (nur Delegation) und kann keine Inhalte direkt erzeugen — verwenden Sie fuer Inhalts-/Code-Schritte einen Soul mit Schreibwerkzeugen.',
    unresolvedRefWarning: 'Verweise auf unbekannte Schritte: {refs} — wahrscheinlich ein Tippfehler oder ein geloeschter Schritt. Klicken Sie auf einen Chip, um einen gueltigen Verweis einzufuegen.',
    failureReasonLabel: 'Fehlergrund',
    viewGrouped: 'Gruppierte Ansicht',
    viewRaw: 'Gesamtes Protokoll',
    runPreamble: 'Start',
    sectionNoOutput: 'Noch keine Ausgabe',
    currentStepLabel: 'Aktueller Schritt: {step} ({soul})',
    currentStepLabelNoSoul: 'Aktueller Schritt: {step}',
    btnExpand: 'Panel erweitern',
    btnRestore: 'Panel wiederherstellen',
    resizeHint: 'Ziehen zum Anpassen der Groesse',
    nodeRunningBadge: 'Laeuft',
  },
}
