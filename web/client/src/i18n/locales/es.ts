export default {
  ...
  sidebar: {
    ...
    terminal: 'Terminal',
    files: 'Archivos',
    flowEditor: 'Flujos del proyecto',
  ...
  chat: {
    ...
    emptyState: 'Inicia una conversacion con GolemGarden',
  ...
  // Flow Studio (flujos independientes del proyecto)
  flowStudio: {
    title: 'Flow Studio',
    create: 'Crear estudio',
    open: 'Abrir',
    emptyTitle: 'Aun no hay estudios',
    emptyDesc: 'Una carpeta es un estudio — crea un nuevo estudio para empezar',
    createSuccess: 'Estudio "{name}" creado',
    agentModal: {
      trigger: 'Anadir agente',
      title: 'Crear nuevo agente',
      nameLabel: 'Nombre (a-z, 0-9, -)',
      namePlaceholder: 'p. ej. researcher',
      modelLabel: 'Modelo',
      roleLabel: 'Rol',
      rolePlaceholder: 'Describe el rol que asumira este agente',
      rulesLabel: 'Reglas (opcional)',
      rulesPlaceholder: 'Reglas/directrices que este agente debe seguir...',
      rankLabel: 'Rango',
      effortLabel: 'Nivel de esfuerzo',
      effortNone: 'No especificado',
      aliasLatest: 'siempre la ultima',
      create: 'Crear',
      success: 'Agente creado',
    },
    createModal: {
      title: 'Nuevo Flow Studio',
      nameLabel: 'Nombre',
      namePlaceholder: 'p. ej. Estudio de investigacion de mercado',
      pathLabel: 'Ruta de la carpeta (absoluta)',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: 'Como quieres empezar?',
      modeBlank: 'Estudio vacio',
      modeBlankDesc: 'Empieza con un lienzo en blanco — anade agentes y flujos tu mismo',
      modePreset: 'Preajuste de equipo',
      modePresetDesc: 'Aplica al instante un equipo y flujo predefinidos',
      modeAi: 'Diseno con IA',
      modeAiDesc: 'Describe un objetivo y deja que flowsmith disene el equipo y el flujo',
      goalLabel: 'Objetivo',
      goalPlaceholder: 'Describe lo que este estudio debe lograr...',
      skipDesignHint: 'No se indico objetivo — se omite la generacion del equipo de IA',
      designRunning: 'La IA esta montando el equipo de agentes y el flujo...',
      designSuccess: 'Equipo de IA generado — agentes y flujo listos',
      designFailed: 'Fallo al generar el equipo de IA',
      presetRunning: 'Aplicando el preajuste...',
      presetSuccess: 'Preajuste aplicado — equipo y flujo listos',
      presetFailed: 'Fallo al aplicar el preajuste',
      skipDesign: 'Simplemente abrir',
      designRun: 'Generar equipo de IA',
      openEditor: 'Abrir editor',
    },
    redesignModal: {
      trigger: 'Redisenar',
      title: 'Redisenar equipo y flujo',
      feedbackLabel: 'Comentarios',
      feedbackPlaceholder: 'Describe lo que te gustaria cambiar...',
      redesign: 'Redisenar',
      success: 'Rediseno completo — flujo actualizado',
      failed: 'Fallo al redisenar',
    },
    errors: {
      nameRequired: 'Introduce un nombre de estudio',
      pathRequired: 'Introduce una ruta de carpeta (p. ej. C:/01_xuefeng/my-studio)',
      nameInvalid: 'El nombre solo puede contener minusculas, numeros y -',
      modelInvalid: 'El ID del modelo solo puede contener letras, numeros y . _ -',
      createFailed: 'No se pudo crear el estudio',
      duplicate: 'Ya existe un estudio con ese nombre/ruta',
      invalidPath: 'Ruta no valida',
      initFailed: 'Fallo al inicializar el estudio',
      presetRequired: 'Selecciona un preajuste',
      goalRequired: 'Introduce un objetivo para el diseno con IA',
      feedbackRequired: 'Introduce un comentario describiendo el cambio deseado',
      tooLong: 'La entrada es demasiado larga (max. 512 caracteres)',
    ...
    delete: {
      ...
      confirm: 'Eliminar "{name}" de la lista? La carpeta y sus artefactos permanecen en el disco.',
      success: 'Estudio "{name}" eliminado',
  ...
  // Flow Editor
  flowEditor: {
    noProject: 'Ningun proyecto seleccionado',
    noProjectDesc: 'Selecciona un proyecto para usar el editor de flujos',
    emptyTitle: 'Aun no hay pasos',
    emptyDesc: 'Anade un paso o comienza desde una plantilla para construir tu flujo de trabajo',
    templateSerial: 'Plantilla en serie (Diseno → Implementacion → Verificacion)',
    templateParallel: 'Plantilla paralela (Implementacion × 2 → Verificacion)',
    templateSerialGoal: 'Disenar, implementar y verificar una funcionalidad',
    templateParallelGoal: 'Implementacion paralela y luego verificacion',
    templateDesign: 'Disenar la solucion',
    templateImpl: 'Implementar la funcionalidad',
    templateImpl2: 'Implementar la alternativa',
    templateVerify: 'Verificar el resultado',
    goalPlaceholder: 'Objetivo del flujo de trabajo…',
    defaultGoal: 'Flujo de trabajo sin titulo',
    btnAddStep: 'Anadir paso',
    btnAddStepTip: 'Anadir un nuevo nodo de paso',
    btnAutoLayout: 'Diseno automatico',
    btnAutoLayoutTip: 'Reorganizar los nodos con el diseno Dagre LR',
    btnValidate: 'Validar',
    btnValidateTip: 'Comprobar si falta contenido de tarea',
    btnSave: 'Guardar',
    btnRun: 'Ejecutar',
    stepDetail: 'Detalle del paso',
    labelSoul: 'SOUL asignado',
    soulHost: 'Host (directo)',
    labelTask: 'Contenido de la tarea',
    taskPlaceholder: 'Describe lo que debe hacer este paso…',
    taskRequired: 'El contenido de la tarea es obligatorio',
    labelRetry: 'Reintentos (0–3)',
    labelApproval: 'Puerta de aprobacion',
    labelOnFail: 'En caso de fallo',
    onFailAbort: 'Abortar',
    onFailContinue: 'Continuar',
    onFailGoto: 'Ir al paso…',
    labelGotoStep: 'Paso objetivo',
    gotoPlaceholder: 'Selecciona un paso…',
    validateErrors: '{n} paso(s) sin contenido de tarea',
    validateOk: 'Todos los pasos estan correctos',
    saveSuccess: 'Flujo de trabajo guardado',
    saveFailed: 'Error al guardar',
    runPanelTitle: 'Salida de ejecucion',
    running: 'Ejecutando…',
    runLogEmpty: 'Aun no hay salida — haz clic en Ejecutar para empezar',
    approvalPending: 'Aprobacion pendiente:',
    btnApprove: 'Aprobar',
    btnReject: 'Rechazar',
    approved: 'Paso aprobado',
    rejected: 'Paso rechazado',
    runDone: 'Flujo de trabajo completado',
    runFailed: 'Flujo de trabajo fallido',
    runWaiting: 'En pausa — se requiere aprobacion',
    phaseDone: 'Completado',
    phaseFailed: 'Fallido',
    phaseWaiting: 'Esperando aprobacion',
    leaveTitle: 'Cambios sin guardar',
    leaveContent: 'Tienes cambios sin guardar. Salir sin guardar?',
    leaveConfirm: 'Salir',
    savedFlows: 'Flujos de trabajo guardados',
    savedFlowsPlaceholder: 'Selecciona un flujo de trabajo guardado…',
    newFlow: 'Nuevo',
    deleteFlow: 'Eliminar',
    deleteFlowConfirm: 'Eliminar este flujo de trabajo? Esta accion no se puede deshacer.',
    deleteTitle: 'Eliminar flujo de trabajo',
    deleted: 'Flujo de trabajo eliminado',
    btnStop: 'Detener',
    deleteFlowSuccess: 'Flujo de trabajo eliminado',
    deleteFlowFailed: 'No se pudo eliminar el flujo de trabajo',
    switchDirtyTitle: 'Cambios sin guardar',
    switchDirtyContent: 'Tienes cambios sin guardar. Cambiar sin guardar?',
    switchDirtyConfirm: 'Cambiar',
    progressCount: '{done}/{total} completados',
    emptyDescWithFlows: 'Carga un flujo de trabajo guardado o comienza desde una plantilla',
    btnDeleteStep: 'Eliminar este paso',
    btnViewResult: 'Ver resultado',
    btnAddInput: 'Anadir entrada',
    btnAddInputTip: 'Anadir un nodo de entrada (valor de entrada del pipeline)',
    btnAddAgent: 'Anadir agente',
    btnAddAgentTip: 'Anadir un nodo de paso de agente',
    nodeKindInput: 'Entrada',
    inputValueLabel: 'Valor de entrada',
    inputValuePlaceholder: 'Valor que se pasa al pipeline…',
    insertRefHint: "{'{{step-id}}'} inserta la salida de ese paso anterior",
    refChipsLabel: 'Pasos anteriores',
    runInputTitle: 'Introducir entrada',
    runInputDesc: 'Este flujo de trabajo comienza con nodos de entrada. Introduce los valores para ejecutarlo.',
    runInputConfirm: 'Introducir y ejecutar',
    resolvedInputLabel: 'Entrada recibida (resuelta)',
    outputLabel: 'Salida',
    directorWarning: 'Este soul es un Director (solo delega) y no puede generar contenido directamente — usa un soul con herramientas de escritura para pasos de contenido/codigo.',
    unresolvedRefWarning: 'Referencias a pasos desconocidos: {refs} — probablemente un error tipografico o un paso eliminado. Haz clic en un chip para insertar una referencia valida.',
    failureReasonLabel: 'Motivo del fallo',
    viewGrouped: 'Vista agrupada',
    viewRaw: 'Registro completo',
    runPreamble: 'Inicio',
    sectionNoOutput: 'Sin salida aun',
    currentStepLabel: 'Paso actual: {step} ({soul})',
    currentStepLabelNoSoul: 'Paso actual: {step}',
    btnExpand: 'Expandir panel',
    btnRestore: 'Restaurar panel',
    resizeHint: 'Arrastra para cambiar el tamano',
    nodeRunningBadge: 'En ejecucion',
  },
}
