export default {
  ...
  // Flow Studio (flux independants du projet)
  flowStudio: {
    title: 'Flow Studio',
    create: 'Creer un studio',
    open: 'Ouvrir',
    emptyTitle: 'Aucun studio pour le moment',
    emptyDesc: 'Un dossier est un studio — creez un nouveau studio pour commencer',
    createSuccess: 'Studio "{name}" cree',
    agentModal: {
      trigger: 'Ajouter un agent',
      title: 'Creer un nouvel agent',
      nameLabel: 'Nom (a-z, 0-9, -)',
      namePlaceholder: 'ex. researcher',
      modelLabel: 'Modele',
      roleLabel: 'Role',
      rolePlaceholder: 'Decrivez le role que cet agent va assumer',
      rulesLabel: 'Regles (optionnel)',
      rulesPlaceholder: 'Regles/consignes que cet agent doit suivre...',
      rankLabel: 'Rang',
      effortLabel: "Niveau d'effort",
      effortNone: 'Non specifie',
      aliasLatest: 'toujours la derniere version',
      create: 'Creer',
      success: 'Agent cree',
    },
    createModal: {
      title: 'Nouveau Flow Studio',
      nameLabel: 'Nom',
      namePlaceholder: "ex. Studio d'etude de marche",
      pathLabel: 'Chemin du dossier (absolu)',
      pathPlaceholder: 'C:/01_xuefeng/my-studio',
      startModeLabel: 'Comment souhaitez-vous commencer ?',
      modeBlank: 'Studio vide',
      modeBlankDesc: "Partir d'une toile vierge — ajoutez agents et flux vous-meme",
      modePreset: "Modele d'equipe",
      modePresetDesc: 'Appliquer instantanement une equipe et un flux predefinis',
      modeAi: 'Conception IA',
      modeAiDesc: "Decrivez un objectif et laissez flowsmith concevoir l'equipe et le flux",
      goalLabel: 'Objectif',
      goalPlaceholder: 'Decrivez ce que ce studio doit accomplir...',
      skipDesignHint: "Aucun objectif renseigne — generation de l'equipe IA ignoree",
      designRunning: "L'IA assemble l'equipe d'agents et le flux...",
      designSuccess: 'Equipe IA generee — agents et flux prets',
      designFailed: "Echec de la generation de l'equipe IA",
      presetRunning: 'Application du modele...',
      presetSuccess: 'Modele applique — equipe et flux prets',
      presetFailed: "Echec de l'application du modele",
      skipDesign: 'Ouvrir simplement',
      designRun: "Generer l'equipe IA",
      openEditor: "Ouvrir l'editeur",
    },
    redesignModal: {
      trigger: 'Repenser',
      title: "Repenser l'equipe et le flux",
      feedbackLabel: 'Retour',
      feedbackPlaceholder: 'Decrivez ce que vous souhaitez changer...',
      redesign: 'Repenser',
      success: 'Repense — flux mis a jour',
      failed: 'Echec de la reconception',
    },
    errors: {
      nameRequired: 'Saisissez un nom de studio',
      pathRequired: 'Saisissez un chemin de dossier (ex. C:/01_xuefeng/my-studio)',
      nameInvalid: 'Le nom ne peut contenir que des minuscules, chiffres et -',
      modelInvalid: "L'ID du modele ne peut contenir que des lettres, chiffres et . _ -",
      createFailed: 'Echec de la creation du studio',
      duplicate: 'Un studio avec ce nom/chemin existe deja',
      invalidPath: 'Chemin non valide',
      initFailed: "Echec de l'initialisation du studio",
      presetRequired: 'Selectionnez un modele',
      goalRequired: 'Saisissez un objectif pour la conception IA',
      feedbackRequired: 'Saisissez un retour decrivant le changement souhaite',
      tooLong: 'La saisie est trop longue (512 caracteres max.)',
    ...
    delete: {
      ...
      confirm: 'Supprimer "{name}" de la liste ? Le dossier et ses artefacts restent sur le disque.',
      success: 'Studio "{name}" supprime',
      error: 'Echec de la suppression du studio',
    },
  },
  ...
  flowEditor: {
    ...
    noProjectDesc: "Selectionnez un projet pour utiliser l'editeur de flux",
    emptyTitle: 'Aucune etape pour le moment',
    emptyDesc: "Ajoutez une etape ou partez d'un modele pour construire votre flux de travail",
    templateSerial: 'Modele en serie (Conception → Implementation → Verification)',
    templateParallel: 'Modele parallele (Implementation × 2 → Verification)',
    templateSerialGoal: 'Concevoir, implementer et verifier une fonctionnalite',
    templateParallelGoal: 'Implementation parallele puis verification',
    templateDesign: 'Concevoir la solution',
    templateImpl: 'Implementer la fonctionnalite',
    templateImpl2: "Implementer l'alternative",
    templateVerify: 'Verifier le resultat',
    goalPlaceholder: 'Objectif du flux de travail…',
    defaultGoal: 'Flux de travail sans titre',
    btnAddStep: 'Ajouter une etape',
    btnAddStepTip: "Ajouter un nouveau noeud d'etape",
    btnAutoLayout: 'Disposition automatique',
    btnAutoLayoutTip: 'Reorganiser les noeuds avec la disposition Dagre LR',
    btnValidate: 'Valider',
    btnValidateTip: 'Verifier le contenu de tache manquant',
    btnSave: 'Enregistrer',
    btnRun: 'Executer',
    stepDetail: "Detail de l'etape",
    labelSoul: 'SOUL assigne',
    soulHost: 'Hote (direct)',
    labelTask: 'Contenu de la tache',
    taskPlaceholder: 'Decrivez ce que cette etape doit faire…',
    taskRequired: 'Le contenu de la tache est requis',
    labelRetry: 'Nouvelles tentatives (0–3)',
    labelApproval: "Portail d'approbation",
    labelOnFail: "En cas d'echec",
    onFailAbort: 'Abandonner',
    onFailContinue: 'Continuer',
    onFailGoto: "Aller a l'etape…",
    labelGotoStep: 'Etape cible',
    gotoPlaceholder: 'Selectionnez une etape…',
    validateErrors: '{n} etape(s) sans contenu de tache',
    validateOk: 'Toutes les etapes semblent correctes',
    saveSuccess: 'Flux de travail enregistre',
    saveFailed: "Echec de l'enregistrement",
    runPanelTitle: "Sortie d'execution",
    running: 'Execution en cours…',
    runLogEmpty: 'Aucune sortie pour le moment — cliquez sur Executer pour commencer',
    approvalPending: 'Approbation en attente :',
    btnApprove: 'Approuver',
    btnReject: 'Rejeter',
    approved: 'Etape approuvee',
    rejected: 'Etape rejetee',
    runDone: 'Flux de travail termine',
    runFailed: 'Flux de travail echoue',
    runWaiting: 'En pause — approbation requise',
    phaseDone: 'Termine',
    phaseFailed: 'Echoue',
    phaseWaiting: 'Approbation en attente',
    leaveTitle: 'Modifications non enregistrees',
    leaveContent: 'Vous avez des modifications non enregistrees. Quitter sans enregistrer ?',
    leaveConfirm: 'Quitter',
    savedFlows: 'Flux de travail enregistres',
    savedFlowsPlaceholder: 'Selectionnez un flux de travail enregistre…',
    newFlow: 'Nouveau',
    deleteFlow: 'Supprimer',
    deleteFlowConfirm: 'Supprimer ce flux de travail ? Cette action est irreversible.',
    deleteTitle: 'Supprimer le flux de travail',
    deleted: 'Flux de travail supprime',
    btnStop: 'Arreter',
    deleteFlowSuccess: 'Flux de travail supprime',
    deleteFlowFailed: 'Echec de la suppression du flux de travail',
    switchDirtyTitle: 'Modifications non enregistrees',
    switchDirtyContent: 'Vous avez des modifications non enregistrees. Changer sans enregistrer ?',
    switchDirtyConfirm: 'Changer',
    progressCount: '{done}/{total} termines',
    emptyDescWithFlows: "Chargez un flux de travail enregistre ou partez d'un modele",
    btnDeleteStep: 'Supprimer cette etape',
    btnViewResult: 'Voir le resultat',
    btnAddInput: 'Ajouter une entree',
    btnAddInputTip: "Ajouter un noeud d'entree (valeur d'entree du pipeline)",
    btnAddAgent: 'Ajouter un agent',
    btnAddAgentTip: "Ajouter un noeud d'etape d'agent",
    nodeKindInput: 'Entree',
    inputValueLabel: "Valeur d'entree",
    inputValuePlaceholder: 'Valeur transmise au pipeline…',
    insertRefHint: "{'{{step-id}}'} insere la sortie de cette etape precedente",
    refChipsLabel: 'Etapes precedentes',
    runInputTitle: "Saisir l'entree",
    runInputDesc: "Ce flux de travail commence par des noeuds d'entree. Saisissez les valeurs pour l'executer.",
    runInputConfirm: 'Saisir et executer',
    resolvedInputLabel: 'Entree recue (resolue)',
    outputLabel: 'Sortie',
    directorWarning: "Ce soul est un Director (delegation uniquement) et ne peut pas produire de contenu directement — utilisez un soul avec des outils d'ecriture pour les etapes de contenu/code.",
    unresolvedRefWarning: 'References a des etapes inconnues : {refs} — probablement une faute de frappe ou une etape supprimee. Cliquez sur une puce pour inserer une reference valide.',
    failureReasonLabel: "Raison de l'echec",
    viewGrouped: 'Vue groupee',
    viewRaw: 'Journal complet',
    runPreamble: 'Demarrage',
    sectionNoOutput: 'Aucune sortie pour le moment',
    currentStepLabel: 'Etape actuelle : {step} ({soul})',
    currentStepLabelNoSoul: 'Etape actuelle : {step}',
    btnExpand: 'Agrandir le panneau',
    btnRestore: 'Restaurer le panneau',
    resizeHint: 'Faites glisser pour redimensionner',
    nodeRunningBadge: 'En cours',
  },
}
